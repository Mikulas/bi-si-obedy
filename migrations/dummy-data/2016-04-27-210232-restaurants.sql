...
INSERT INTO "jidlo" ("cena", "nazev", "popis", "jidelniListekID") VALUES
  ...
  (30,	'Kuřecí maso na paprice, knedlík', 'Těstovinový salát s tuňákem', 1),
  (120,	'Hovězí maso, houbová omáčka, knedlík', 'Rybí file v sýrovém obalu, brambor', 1),
  (30,	'Vepřová pečeně na žampionech, brambor', 'Bramborové šišky s cukrem a mákem', 1),
  (60,	'Smažený sýr, brambor', 'Hovězí maso na rajčatech, těstoviny', 1),
  (45,	'Hovězí maso, koprová omáčka, knedlík', 'Srbský plátek, rýže', 1),
  (165,	'Bramborové šišky s cukrem a mákem', 'Nudle s kakaem', 1),
  (90,	'Ražniči na plechu, chléb', 'Vepřová pečeně na žampionech, brambor', 1),
  (150,	'Halušky s uzeným masem a zelím', 'Vepřové maso v mrkvi, rozpek', 2),
  (30,	'Vepřový tokáň, těstoviny', 'File na grilu, brambor', 2),
  (45,	'Zapečené těstoviny', 'Klopsy v rajské omáčce, těstoviny', 2),
  (75,	'Smažený květák, brambor', 'Smažený květák, brambor', 2),
  (90,	'Vepřové maso v mrkvi, rozpek', 'Soukenický řízek, bramborová kaše', 2),
  (30,	'Vepřová játra na slanině, rýže', 'Masový nákyp, brambor', 2),
  (75,	'Hovězí maso na paprikách, těstoviny', 'Sekaná pečeně, bramborová kaše', 2),
  (30,	'Bratislavské plecko, těstoviny', 'Dukátové buchtičky s krémem', 3),
  (45,	'Nudle s kakaem', 'Rýžový nákyp', 3),
  (105,	'Hovězí maso na celeru, těstoviny', 'Kuřecí kung pao, rýže', 3),
  (90,	'File na grilu, brambor', 'Hovězí ragů na paprice, těstoviny', 3),
  (30,	'Rybí file v sezamovém obalu, brambor', 'Švestkové knedlíky s tvarohem a cukrem', 3),
  (90,	'Vepřová pečeně po cikánsku, brambor', 'Moravský vrabec, bramborová kaše', 3),
  (45,	'Rýžový nákyp', 'Selská vepřová pečeně, brambor', 3),
  (120,	'Jemné zapečené brambory', 'Zeleninové rizeto', 4),
  (135,	'Segedinský guláš, knedlík', 'Masový závitek francouzský, rýže', 4),
  (120,	'Svíčková na smetaně, knedlík', 'Srbská musaka, brambor (zapečený květák s mletým masem', 4),
  (105,	'Hovězí maso, křenová omáčka, knedlík', 'Hovězí maso na zelenině, těstoviny', 4),
  (150,	'Fazole na kyselo, párek, rohlík', 'Hovězí maso, rajská omáčka, knedlík', 4),
  (135,	'Srbská musaka, brambor (zapečený květák s mletým masem)', 'Ražniči na plechu, chléb', 5),
  (30,	'Kuře na zelí, bramborová buchta', 'Azu po tatarsku, rýže', 5),
  (60,	'Květákovo sýrový řízeček,brambor', 'Vepřová pečeně, zelí, knedlík', 5),
  (60,	'Máslový řízek, brambor', 'Rybí file na grilu, brambor', 5),
  (105,	'Hovězí maso na smetaně, knedlík', 'Žemlovka s jablky', 5),
  (75,	'Bůčková roláda, brambor', 'Hovězí maso, křenová omáčka, knedlík', 5),
  (90,	'Rizeto z vepřového masa', 'Vepřový tokáň, těstoviny', 5),
  (60,	'Hovězí maso na rajčatech, těstoviny', 'Hovězí maso na smetaně, knedlík', 5),
  (45,	'Špagety po milánsku', 'Bavorské vdolečky', 5),
  (165,	'Vepřové nudličky po čínsku,rýže', 'Bramborové šišky se strouhankou', 6),
  (30,	'Španělský ptáček, rýže', 'Krupicová kaše s kakaem', 6),
  (45,	'Těstovinový salát s tuňákem', 'Králiči hřbet na smetaně, knedlík', 6),
  (105,	'Čočka s párkem, bramborová buchta, okurka', 'Hovězí maso po italsku, těstoviny', 6),
  (60,	'Vepřová pečeně, špenát, špekové knedlíky', 'Vepřová směs sombrero, rýže', 7),
  (60,	'Maďarský guláš, těstoviny', 'Povidlové knedlíky s tvarohem', 7),
  (90,	'Dukátové buchtičky s krémem', 'Rybí file v sezamovém obalu, brambor', 7),
  (105,	'Opékaný karbanátek, bramborová kaše', 'Čočka s párkem, bramborová buchta, okurka', 7),
  (135,	'Hovězí ragů na paprice, těstoviny', 'Roštěná na žampionech, rýže', 8),
  (60,	'Báječné zapečené těstoviny', 'Bramborové knedlíky s uzeným masem a cibulkou', 9);
